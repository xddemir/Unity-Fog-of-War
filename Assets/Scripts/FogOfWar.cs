...
public class FogOfWar : MonoBehaviour
{
    ...
    void FindVisibleTarget()
    {
        ...
        for (int i = 0; i < targetsInViewRadius.Length; i++)
        {
            ...
            if (Vector3.Angle(transform.forward, dirToTarget) < viewAngle / 2)
            {
                ...
                if (!Physics.Raycast(transform.position, dirToTarget, dstToTarget, obstacleMas)) {
    ...
    void DrawFogOfWar()
    {
        ...
        for (int i = 0; i <= stepCount; i++)
        {
            ...
            //                transform.position + DirFromAngle(angle, true) * viewRadius, 
            //                Color.red);

        }

        // ViewPoints + originVertex
    ...
    ViewCastInfo ViewCast(float globalAngle)
    {
        ...
        if (Physics.Raycast(transform.position, dir, out hit, viewRadius, obstacleMas)) {
